...
### Première connexion
1. **Accès à la plateforme** via l'adresse : < 51.195.80.167:8098 >
2. **Authentification** avec vos identifiants professionnels
...
- **Photos** : netteté, angles de vue, légendes
- **Schémas** : clarté, orientation, échelle
- **Documents** : lisibilité, validité
...
- Qualité des photos et documents
- Cohérence interne du constat
