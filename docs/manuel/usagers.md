...
6. **Validez par SMS** :
   - Vous recevez un code à 6 chiffres
...
**Q : Combien de temps pour obtenir le constat officiel ?**  
R : 1 à 3 jours en moyenne, selon la complexité et la charge de travail des autorités.

**Q : Puis-je modifier ma déclaration après envoi ?**  
R : Oui, dans les 24h. Après, contactez le support pour modification.

**Q : Mon attestation est-elle valable légalement ?**  
R : Oui, les attestations DOSER sont reconnues officiellement et peuvent être vérifiées via QR Code.
